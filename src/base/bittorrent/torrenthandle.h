...
namespace BitTorrent
{
    ...
    enum class SelectTaskHandleType {
        Select_All_Handle = 0,

        Select_BitTorrent_Handle = 1,
        Select_XDown_Handle = 2,
    };


    enum class TaskHandleActionType {
        Unknown_ActionType = -1,
        ActionType_None = 0,
        ActionType_Convert,
        ActionType_Merge,
        ActionType_Version_Dns_Over_Https,
        ActionType_UpdateTxt,
        ActionType_UpdateZip,
        ActionType_Magnet,
        ActionType_UpdateTracker,
    };
    ...
    public:
        ...
        virtual TaskHandleType getHandleType() const = 0;

        virtual void setHandleActionType(TaskHandleActionType iValue) = 0;
        virtual TaskHandleActionType getHandleActionType() const = 0;

        virtual bool checkIsUpdateHandle() const = 0;

        virtual aria2::A2Gid getGid() const = 0;
        virtual void setGid(const aria2::A2Gid gidValue) = 0;
		...
		virtual void setErrorMessage(const QString &strValue) = 0;
        ...
        virtual QString getItemHash() const = 0;
