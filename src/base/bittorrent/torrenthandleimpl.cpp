...
TorrentHandleImpl::TorrentHandleImpl(Session *session, lt::session *nativeSession
    ...
    , m_name(params.name)
    , m_handleType(TaskHandleType::BitTorrent_Handle)
...
TaskHandleType TorrentHandleImpl::getHandleType() const
{
    return m_handleType;
}


QString TorrentHandleImpl::url() const
{
    return "";
}

QString TorrentHandleImpl::source() const
{
    return "";
}

void TorrentHandleImpl::setHandleActionType(TaskHandleActionType iValue)
{

}

TaskHandleActionType TorrentHandleImpl::getHandleActionType() const
{
    return TaskHandleActionType::ActionType_None;
}

bool TorrentHandleImpl::checkIsUpdateHandle() const {
    return false;
}

aria2::A2Gid TorrentHandleImpl::getGid() const
{
    return 0;
}
void TorrentHandleImpl::setGid(const aria2::A2Gid gidValue)
{

}

void TorrentHandleImpl::setErrorMessage(const QString &strValue)
{

}

QString TorrentHandleImpl::getErrorMessage() const
{
    return "";
}
...
QString TorrentHandleImpl::getItemHash() const
{
    return "";
}
