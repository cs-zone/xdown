...
void Utils::Misc::shutdownComputer(const ShutdownDialogAction &action)
{
    ...
    {
        const QString msg = QCoreApplication::translate("misc", "XDown will shutdown the computer now because all downloads are complete.");
...
QString Utils::Misc::qBitTorrentVersionString()
{
    return QString::fromLatin1(QBT_VERSION);
}
