...
public:
    ...
    void SetActiveTabToHttp();
    void SetActiveTabToDefault();
...
private slots:
	...
	void toggleEnableAddTrackers();
    void reinitializeExtensionClicked();
    void enableProxyCheckChanged();
    void enableAuthenCheckChanged();
