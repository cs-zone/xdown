...
public slots:
    ...
    void updateSelectedDownloadLink();
	void copySelectedXDownURIs() const;
	void openSelectedTorrentsFile() const;
...
protected:
    ...
    // = 1 所有BT下载任务
    // = 2 所有http（xdown）下载任务
    QVector<BitTorrent::TorrentHandle *> getSelectedTorrents(BitTorrent::SelectTaskHandleType iValueType = BitTorrent::SelectTaskHandleType::Select_All_Handle) const;
