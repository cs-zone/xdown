...
public:
    explicit MainWindow(QWidget *parent = nullptr, bool bIsHideWindow = false);
    ~MainWindow() override;
    ...
    void onEnableMenuAndButton(bool bIsEnable);
    ...
    void OnShowOptionDlg(bool bIsTop, int iActiveTab);
    bool actionOnCreateTask(const QString& strJson);

    void OnEmptyTagXDownMsg();
...
private slots:
    ...
    void xdownNew(BitTorrent::TorrentHandle *const xdown) const;
    void handleEnableMenuAndButton(bool bEnable);
    ...
    void handleUpdateLinkToOK(const QString &strVal, const QString &strUpdateLinkVal);
    void handleUpdateLinkToExit();
    ...
    void handleOnShowOptionDlg(bool bIsTop, int iActiveTab);
    bool handleOnCreateTask(const QString& strJson);
    void handleOnShowUpdateLinkDlg(const QString &strUrl);
...
private:
    ...
    QPointer<XUpdateLinkDialog> m_updateLinkDialog;
